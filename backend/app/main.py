...
from app.api import auth, matters, contacts, documents, clio_fields, templates, document_types, fields, firm_settings
...
from app.models import firm_settings as _fs_model  # ensure model is registered
...
app.include_router(firm_settings.router, prefix="/api")
